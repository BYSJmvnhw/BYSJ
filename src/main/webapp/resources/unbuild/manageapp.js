...
define(function (require, exports, module) {
    ...
    var CollegeList = React.createClass({
        ...
        render: function () {
            ...
            return (<select>{campusNode}</select>);
        }
    });
    ...
    var SelectCollege = React.createClass({
        render: function () {
            return (
                <div className={this.props.className}>
                    <label>学院</label>
                    <CollegeList url={serverpath + "student/collegeList"} campusId={this.props.campusId}/>
                </div>
            );
        }
    });
        ...
        render: function () {
            return (
                <div className="dialog-body" ref="dialogBody">
                    <SelectCampus className="add-cs-campus" onChange={this.setSelectCampus}/>
                    <SelectCollege className="add-cs-college" campusId={this.state.campusId}/>
            ...
            return (
                <div className="cs-manage">
                    <div className="cs-manage-search box-style" ref="searchData">
                        <SelectCampus className="campus-id" onChange={this.setSelectCampus}/>
            ...
            return (
                <div className="cs-manage">
                    <div className="cs-manage-search box-style" ref="searchData">
                        ...
                        <StudentNoName className="course-no" onKeyDown={this.keyDownSearchTake}/>
                        <div className="cs-search-btn">
                            <button onClick={this.searchStudent}>搜索课程</button>
                        </div>
                        <div className="cs-addnew">
